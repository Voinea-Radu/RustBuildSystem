...
public class PlaceableSchematic extends BuildSchematic {
    public PlaceableSchematic() {
    }

    public PlaceableSchematic(String type, Position rootOffset, HashMap<Position, List<XMaterial>> offsets, List<Cost> cost, List<Integer> heath, int canCollideUnder) {
